...
# --- Pydantic models for Git commands ---
...
# --- Enum listing available Git tools ---
...
def git_commit(repo: git.Repo, message: str) -> str:
    # Ensure the commit message starts with '[agent]'
    ...
    return f"Changes committed successfully with hash {commit_hash}"
...
async def serve(repository: Path | None) -> None:
    ...
    async def list_tools() -> list[Tool]:
        return [
            ...
            Tool(
                ...
                description="Records changes to the repository with a signed commit. The commit message must start with '[agent]'.",
    ...
    async def call_tool(name: str, arguments: dict) -> list[TextContent]:
        ...
        # For all other commands, we require an existing repository.
